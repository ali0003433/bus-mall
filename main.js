...
function imageClicked(event){
    ...
    //invoke displayImages to display 3 new images
    displayImages();
...
function displayImages() {
    ...
    for(let i = 0; i <3; i++){
        ...
        if( i === 0){
            console.log(firstImage = imageObject)
        //if second iteration, assign the random image chosen to secondImage
        } else if (i === 1) {
            while(imageObject.id === firstImage.id){
                console.log('entering while',imageObject.id)
                imageObject = randomImage();
                console.log('new try while i=2',imageObject.id)
                }
            console.log(secondImage = imageObject);
        //if anything other than first or second iteration, assign the random images chosen to thirdImage
            ...
            imageObject = randomImage();
            console.log('new try while i=3', imageObject.id)
            }
        console.log(thirdImage = imageObject);
        }
